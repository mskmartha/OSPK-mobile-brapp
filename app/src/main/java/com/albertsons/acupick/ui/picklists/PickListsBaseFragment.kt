...
abstract class PickListsBaseFragment<VM : PickListsBaseViewModel, BINDING : ViewDataBinding> : BaseFragment<VM, BINDING>() {
    // DI
    val networkAvailabilityManager: NetworkAvailabilityManager by inject()

    // Constrain fragmentViewModel type to PickListBaseViewModel using generic typing,
